...
import { homeRoutes } from './applications/home/home.routes'
...
export const routes: Routes = [
  {
    ...
    children: [...homeRoutes, ...recentsRoutes, ...favoritesRoutes, ...searchRoutes, ...spacesRoutes, ...userRoutes, ...syncRoutes, ...adminRoutes]
  },
  ...authRoutes,
  ...linksRoutes,
