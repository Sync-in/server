...
import { LucideDynamicIcon, LucideTrash2, LucideUserMinus } from '@lucide/angular'
...
export class AdminGroupDeleteDialogComponent {
  ...
  protected readonly icons = { GROUPS: USER_ICON.GROUPS, LucideTrash2, LucideUserMinus }
