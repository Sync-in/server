...
export const SPACES_MENU: AppMenu = {
  ...
  matchLink: new RegExp(`^${SPACES_PATH.SPACES}|^${SPACES_PATH.TRASH}|^${SPACES_PATH.SHARES}|^${SPACES_PATH.SHARED}|^${SPACES_PATH.LINKS}|^${FAVORITES_PATH.BASE}|^${RECENTS_PATH.BASE}`),
  submenus: [
    {
      title: RECENTS_TITLE,
      icon: RECENTS_ICON,
